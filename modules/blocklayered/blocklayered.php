...
class BlockLayered extends Module
{
    ...
    protected function assignProductsAttributesGroups(){
        ...
        foreach ($this->products as $cat_product)
        {
            $product = new Product (intval($cat_product['id_product']), true , $language_id);
            $colors = array();
            $groups = array();
            $combinations = array();
            $attributes_groups = $product->getAttributesGroups($language_id);
    ...
    protected function assignProductsAttributesCombinations()
    {
        ...
        $smarty->assign('productsAttributesCombinations', $products_attributes_combinations);
    }
