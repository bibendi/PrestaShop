...
//country number exceptions
define("country_prefix_def_7","89"); //russia 89xxxxxxxxx -> 9xxxxxxxxxx -> +79xxxxxxxxxx
define("country_prefix_def_length_7","11"); //russia
define("country_prefix_trim_char_7","1");  //russia

define("country_prefix_def_380","80"); //ukraine 80xxxxxxxxx -> xxxxxxxxx -> +380xxxxxxxxx
define("country_prefix_def_length_380","11"); //ukraine
define("country_prefix_trim_char_380","2");  //ukraine
...
define("v_about_version","Модуль СМС для PrestaShop 2013, версия");
define("v_about_copyright","Copyright © 2012-2013 TOPefekt s.r.o., Все права защищены");
...
define("v_adminsmsprofile_street","Адрес - улица:");
define("v_adminsmsprofile_city","Адрес - город:");
define("v_adminsmsprofile_zip","Адрес - почтовый индекс:");
define("v_adminsmsprofile_country","Адрес - страна:");
...
define("v_adminsmsprofile_deletedbhint","Позволяет решить, следует ли сохранить существующие настройки, а также базы данных отправленных СМС в случае удаления Prestashop СМС модуля.");
...
define("v_adminsmsprofile_loginerror","ошибка авторизации");
...
define("v_adminsmsprofile_accountchanged2","Аккаунт был изменен, но PrestaShop URL для получения отчетов о доставке не отвечает");
...
define("v_smshistory_description","Журнал СМС сообщений, отправленных с помощью Prestashop СМС-модуля");
...
define("v_smsprestashop_sqltemplate1","Новый заказ от {customer_firstname} {customer_lastname}, id пользователя: {customer_id}, номер заказа: {order_id}, оплата: {order_payment}, сумма: {order_total_paid} {order_currency}. Заказ: {newOrder2}. Информация из {shop_name}.");
...
define("v_smswizard_price","ЦЕНА СМС В ЕВРОВАЛЮТЕ (без / с НДС)");
...
define("v_about_manual_text","Руководство про смс PrestaShop (ENG):");
