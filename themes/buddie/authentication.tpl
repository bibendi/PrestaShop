		...
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="submit">
					...
					<span class="out_button"><input type="button" id="SubmitCreate" name="SubmitCreate" class="button_large" value="{l s='Create your account'}" /></span>
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
					<span class="out_button"><input type="submit" id="SubmitLogin" name="SubmitLogin" class="button" value="{l s='Log in'}" /></span>
				</p>
			</div>
		</fieldset>
	</form>
...
<form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form" class="std">
	...
	<p class="cart_navigation required submit">
		...
		{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
		<span class="out_button"><input type="submit" name="submitAccount" id="submitAccount" value="{l s='Register'}" class="exclusive" /></span>
