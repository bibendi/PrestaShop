...
<p class="cart_navigation">
	<span class="out_button"><input type="submit" name="submit" value="{l s='I confirm my order' mod='bankwire'}" class="exclusive_large" /></span>
	<a href="{$link->getPageLink('order', true, NULL, "step=3")}" class="button_large"><span class="in_button">{l s='Other payment methods' mod='bankwire'}</span></a>
</p>
</form>
{/if}
