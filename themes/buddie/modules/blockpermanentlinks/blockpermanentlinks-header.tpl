...
<ul id="header_links">
	...
	<li><a href="{$link->getPageLink('cms.php?id_cms=4')}" title="{l s='About Us' mod='blockpermanentlinks'}"  {if $page_name=='cms'}class="active"{/if}>{l s='About Us' mod='blockpermanentlinks'}</a></li>
