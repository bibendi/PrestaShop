...
{if isset($css_files)}
	...
	{/foreach}
{/if}
{if $cookie->__get('buddie_color')}
	{assign var='color' value=$cookie->__get('buddie_color')}
{elseif Configuration::get('COLOR_THEME')}
	{assign var='color' value=Configuration::get('COLOR_THEME')}
{else}
	{assign var='color' value="default"}
{/if}
	<link href="{$css_dir}{$color}/global.css" rel="stylesheet" type="text/css" media="{$media}" />
